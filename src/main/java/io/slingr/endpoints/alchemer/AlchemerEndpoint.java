package io.slingr.endpoints.alchemer;
...
/**
 * Alchemer endpoint
 * Created by agreggio on 02/07/23.
 */
@SlingrEndpoint(name = "alchemer", functionPrefix = "_")
public class AlchemerEndpoint extends HttpEndpoint {
    private static final Logger logger = LoggerFactory.getLogger(AlchemerEndpoint.class);
    private static String US_API_URL = "https://api.alchemer.com/v5";
    private static String CA_API_URL = "https://api.alchemer-ca.com/v5";
    private static String EU_API_URL = "https://api.alchemer.eu/v5";
